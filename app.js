...
var proxyUrl = 'https://cors-anywhere.herokuapp.com/',
    cbm_currency_url_ = 'http://forex.cbm.gov.mm/api/latest'
var cbm_info_ ;
fetch(proxyUrl + cbm_currency_url_)
  ...
  .then(data => {
   ...
   // console.log(json_data_);
    ...
    var json_parse_data_info_ = json_prase_.info;
    //console.log(json_parse_data_info_);
    return data;
  })
  . then (function (data){
    var currency = Object.values(data.rates);
    var currency_name_ = Object.getOwnPropertyNames(data.rates);
    var cbm_info_name_ = data.info;
    document.getElementById("info_").innerHTML = cbm_info_name_ +"<br>"+ Date();
  ...
  for (var i = 0; i <currency.length; i++) {
        ...
        var rate_change_ = document.createTextNode(currency[i]+ " MMK");
